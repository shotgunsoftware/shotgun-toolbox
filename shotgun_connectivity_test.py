...
if __name__ == '__main__':
    parser = ArgumentParser(description="Test connectivity to the Shotgun endpoints.\n"
                                        "When invoked with no options, default to:\n"
                                        "\tshotgun_connectivity_test.py --all\n")
    parser.add_argument("--short", help="Default. Test connectivity to all end-oints.",
                        action="store_true")
